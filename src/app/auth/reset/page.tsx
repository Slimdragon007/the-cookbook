      ...
      <div className="w-full max-w-md flex flex-col items-center">
        ...
        {sent ? (
          <div className="w-full flex flex-col items-center text-center animate-drift-up">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-accent-soft text-accent-ink mb-5">
              <Mail size={24} aria-hidden />
            </div>
            <h2 className="font-display text-h2 text-ink mb-3">
              Check your email
            </h2>
            <p className="font-sans text-base text-ink-soft leading-relaxed max-w-[320px]">
        ...
        <Link
          href="/login"
          className="font-sans text-sm font-medium text-accent hover:text-accent-ink transition-colors mt-8"
        >
          Back to login
        </Link>
      </div>
